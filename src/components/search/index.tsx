...
export const SearchComponent: FC<SearchComponentProps> = ({ onChange }) => {
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <input type='text' value={inputValue} className={classes.input} onChange={onChangeSearch} placeholder='Search...' />
      <button onClick={handleSearchValue}>Search</button>
      <button className={classes.error} onClick={initError}>Error</button>
    </div>
  )
}